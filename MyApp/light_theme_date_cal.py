...
# Form implementation generated from reading ui file 'Designing/light_theme_date_cal.ui'
#
...
"selection-background-color: rgb(116, 116, 116);")
        ...
        self.dc_from = QtWidgets.QLabel(self.frame)
        self.dc_from.setGeometry(QtCore.QRect(20, 130, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.dc_from.setFont(font)
        self.dc_from.setStyleSheet("color: rgb(117, 117, 117);")
        self.dc_from.setObjectName("dc_from")
        self.dc_diff_val = QtWidgets.QLabel(self.frame)
        self.dc_diff_val.setGeometry(QtCore.QRect(20, 330, 301, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.dc_diff_val.setFont(font)
        self.dc_diff_val.setStyleSheet("color: rgb(117, 117, 117);")
        self.dc_diff_val.setObjectName("dc_diff_val")
        self.dc_to = QtWidgets.QLabel(self.frame)
        self.dc_to.setGeometry(QtCore.QRect(20, 210, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.dc_to.setFont(font)
        self.dc_to.setStyleSheet("color: rgb(117, 117, 117);")
        self.dc_to.setObjectName("dc_to")
        self.dc_diff = QtWidgets.QLabel(self.frame)
        self.dc_diff.setGeometry(QtCore.QRect(20, 290, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.dc_from_date_btn.setFont(font)
        self.dc_from_date_btn.setStyleSheet("color: rgb(117, 117, 117);\n"
"border-radius: 50px;\n"
...
"")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../images/text.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuOption.setIcon(icon2)
        self.menuOption.setObjectName("menuOption")
        self.menuCalculator = QtWidgets.QMenu(self.menuOption)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../images/calculator(3).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuCalculator.setIcon(icon3)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../images/calculator.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStandard.setIcon(icon6)
        self.actionStandard.setObjectName("actionStandard")
        self.actionScientific = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../images/microscope.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionScientific.setIcon(icon7)
        self.actionScientific.setObjectName("actionScientific")
        self.actionProgrammer = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../images/code.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
