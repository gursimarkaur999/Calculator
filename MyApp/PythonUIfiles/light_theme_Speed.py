...
class Ui_MainWindow_Speed(object):
    def setupUiSpeed(self, MainWindow):
...
"")
        ...
        self.sp_label_1.setGeometry(QtCore.QRect(10, 20, 311, 31))
        font = QtGui.QFont()
        ...
        self.sp_label_2.setGeometry(QtCore.QRect(10, 100, 311, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
...
"")
        ...
        self.sp_retranslateUi(MainWindow)
        self.sp_comboBox_2.setCurrentIndex(1)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def sp_retranslateUi(self, MainWindow):
...
if __name__ == "__main__":
    ...
    ui = Ui_MainWindow_Speed()
    ui.setupUiSpeed(MainWindow)
    MainWindow.show()
    sys.exit(app.exec_())
